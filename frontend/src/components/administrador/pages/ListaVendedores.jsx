...
const ListaVendedores = () => {
    ...
    useEffect(() => {
        axios.get(`${USER_API_URL}/vendedor`)
        .then((response) => {
    ...
    const eliminarVendedor = (e) => {
        e.preventDefault()
        const id_vendedor = idUsuarioEliminar
        axios.delete(`${USER_API_URL}/vendedor/${id_vendedor}`).then((response) => {
  ...
  return (
    <div className="admin-list-container">
        <div className="list-header">
            ...
            <Link to="/administrador/crear_vendedor" className="btn btn-success">Crear Nuevo Vendedor</Link>
        </div>
                ...
                <tbody>
                    ...
                    data.map((vendedor) => (
                        ...
                        <td className="actions-cell">
                            <Link to={`/administrador/editar_vendedor/${vendedor.id_vendedor}`} className="btn btn-warning">Editar</Link>
                            <Link to="#" className="btn btn-danger" onClick={() => mostrarModal(vendedor.nombre_completo, vendedor.id_vendedor)}>Eliminar</Link>
                        </td>
                    </tr>
                    ))
                    }
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
                <button type="button" class="btn btn-success" onClick={eliminarVendedor}>Si, eliminar</button>
