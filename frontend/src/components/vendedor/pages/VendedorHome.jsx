...
const VendedorHome = () => {
    ...
    useEffect(() => {
        axios.get(`${USER_API_URL}/venta/por_estado_venta/6`)
        .then((response) => {
            ...
            <table className="data-table sales-table">
                ...
                <tbody>
                    ...
                    data.map((venta) => (
                        ...
                        <td><span className="status-badge status-processing">Por confirmar</span></td>
                        <td className="actions-cell">
                            <Link to={`/vendedor/detalle_por_confirmar/${venta.id_venta}`} className="btn btn-info">Ver Detalles</Link>
                        </td>
                    </tr>
                    ))
                    }
