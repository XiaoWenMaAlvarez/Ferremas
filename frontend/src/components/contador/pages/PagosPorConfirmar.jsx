...
const PagosPorConfirmar = () => {
    ...
    useEffect(() => {
        axios.get(`${USER_API_URL}/venta/por_estado_venta/1`)
        .then((response) => {
  ...
  return (
    <div className="admin-list-container">
        <div className="list-header">
            <h1>Listado de Pedidos con Pagos por confirmar</h1>
            </div>
                ...
                <tbody>
                    ...
                    data.map((venta) => (
                        ...
                        <td className="actions-cell">
                            <Link to={`/contador/detalle_pedido_por_pagar/${venta.id_venta}`} className="btn btn-info">Ver Detalles</Link>
                        </td>
                    </tr>
                    ))
                    }
